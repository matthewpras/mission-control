...
const WORKSPACE = process.env.OPENCLAW_WORKSPACE || 'C:\\Users\\matthew prasanth\\.openclaw\\workspace';

// Paths
const MEMORY_DIR = path.join(WORKSPACE, 'memory');
const MEMORY_FILE = path.join(WORKSPACE, 'MEMORY.md');
const VECTOR_DB_PATH = path.join(WORKSPACE, 'vector-memory', 'vectors_local.json');
...
async function getEmbedder() {
    ...
    env.cacheDir = path.join(WORKSPACE, '.cache', 'transformers');
